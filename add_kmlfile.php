...
<ul class="collapsible accordion">
        <li ><a href="dashboard.php"><img src="img/icons/packs/fugue/16x16/dashboard.png" alt="" height=16 width=16>WELCOME</a></li>
		<li ><a href="gis.php"><img src="img/icons/packs/fugue/16x16/chart.png" alt="" height=16 width=16>VIEW GIS MAP</a></li>
        <li class="current"><a href="add_kmlfile.php"><img src="img/icons/packs/fugue/16x16/application-form.png" alt="" height=16 width=16>ADD NEW DATA</a></li>
    </ul>
</nav><!-- End of nav -->
</div><!-- End of .top -->
