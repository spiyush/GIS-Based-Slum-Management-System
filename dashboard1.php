...
<ul class="collapsible accordion">
        <li class="current"><a href="index.php"><img src="img/icons/packs/fugue/16x16/dashboard.png" alt="" height=40 width=40>WELCOME</a></li>
        <li><a href="add_kmlfile1.php"><img src="img/icons/packs/fugue/16x16/application-form.png" alt="" height=20 width=20>ADD NEW DATA</a></li>
</ul>
</nav><!-- End of nav -->
</div><!-- End of .top -->
